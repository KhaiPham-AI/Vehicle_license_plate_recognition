...
# load model
yolo_LP_detect = torch.hub.load('./yolov5', 'custom', path='yolo_LP_Detect.pt', force_reload=True, source='local')
yolo_license_plate = torch.hub.load('./yolov5', 'custom', path='yolo_LP_Recognition.pt', force_reload=True, source='local')
